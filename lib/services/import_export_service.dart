...
import 'package:nasbeat/services/m3u_processor.dart';
...
class ImportExportService {
  ...
  static Future<String?> exportPlaylist(String playlistName,
    ...
    try {
      ...
      final Map<String, dynamic> playlistMap = {
        '_meta': {
          'generated_by': 'NasBeat - Open Source Music Streaming Application',
          'version':
              'v${packageInfo.version}+${int.parse(packageInfo.buildNumber) % 1000}',
          'exportedAt': DateTime.now().toIso8601String(),
          'format': 'v2',
          'note':
              'This file is automatically generated by NasBeat and is intended solely for importing playlists within the application.',
        },
      ...
      final path = await writeToJSON(
          '${playlistDB.name}_NasBeatPlaylist.json', playlistMap,
          path: filePath);
  ...
  static Future<String?> exportTrack(TrackDB trackDB) async {
    try {
      ...
      final path =
          await writeToJSON('${trackDB.title}_NasBeatSong.json', trackMap);
